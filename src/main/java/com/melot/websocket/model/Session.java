...
public class Session {
    ...
    public ChannelFuture sendText(TextWebSocketFrame frame) {
    ...
    public ChannelFuture sendBinary(BinaryWebSocketFrame frame) {
        return channel.writeAndFlush(frame);
    }
    ...
    /**
     * Returns the autoconfigure of this channel.
     */
